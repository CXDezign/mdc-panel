...
#card-generators-charges:hover i {
	color: <?= $cArrestCalculator ?>!important;
	text-shadow: <?= $cArrestCalculator ?>80 0 0 15px, 0px 1px 0 rgba(0, 0, 0, .75);
}
...
#card-generators-sd-incident:hover {
	box-shadow: <?= $cSDIncident ?> 0 1px 0px;
}

#card-generators-sd-incident:hover i {
	color: <?= $cSDIncident ?>!important;
...
#card-generators-trespass:hover {
	box-shadow: <?= $cTrespass ?> 0 1px 0px;
}

#card-generators-trespass:hover i {
	color: <?= $cTrespass ?>!important;
	text-shadow: <?= $cTrespass ?>80 0 0 15px, 0px 1px 0 rgba(0, 0, 0, .75);
}
...
#card-generators-charges:hover {
	box-shadow: <?= $cArrestCalculator ?>80 0 -1px 0px;
}

#card-generators-charges:hover i {
	text-shadow: <?= $cArrestCalculator ?>80 0 0 15px, 0px -1px 0 rgba(0, 0, 0, .5);
}
...
#card-generators-sd-incident:hover {
	box-shadow: <?= $cSDIncident ?>80 0 -1px 0px;
}
...
#card-generators-trespass:hover {
	box-shadow: <?= $cTrespass ?>80 0 -1px 0px;
}

#card-generators-trespass:hover i {
	text-shadow: <?= $cTrespass ?>80 0 0 15px, 0px -1px 0 rgba(255, 255, 255, .5);
}
