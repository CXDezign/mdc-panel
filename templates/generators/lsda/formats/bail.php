<div style="background-color:#fafafa;padding:5px; border-radius:3px;">
    ...
    <hr style="color:#555555;font-size:14px;">
    <ul style="color:#555555;font-size:14px;">
        <?= $chargesGroup ?>
        <li style="color:#555555;font-size:14px;">
            <?= $total ?></strong>
        </li>
    </ul>
    <hr style="color:#555555;font-size:14px;">
    ...
    <hr style="color:#555555;font-size:14px;">
    <p style="color:#555555;font-size:14px;">
        <span style="color:#555555;font-size:14px;">The District Attorney's Office affirms that all information submitted is accurate, and truthful given all the information and evidence available, and has been affirmed by <?= $pg->getRank($_POST["inputRank"]) ?><span>&nbsp;</span></span><strong style="color:#555555;font-size:14px;"><?= $_POST["employeeName"] ?></strong><span style="color:#555555;font-size:14px;"><span>&nbsp;</span>that this shall be the official bail petition&nbsp;submitted for the approval of the&nbsp;Superior Court.&nbsp;</span>
    </p>
</div>
