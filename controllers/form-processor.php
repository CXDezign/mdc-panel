<?php
	...
	if (isset($_POST['generatorType'])) {
		...
		if ($generatorType == "TrafficReport") {
			...
			setCookiePost('callSign');
			setCookiePost('officerNameArray');
			setCookiePost('officerRankArray');
			setCookiePost('officerBadgeArray');
			setCookiePost('defName');
