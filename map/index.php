...
L.marker([-59.3,57.9],{icon: iconGovernmentBuilding}).bindPopup(governmentLoc03,popupOptions).addTo(governmentLoc);
...
L.marker([40.2,38.5],{icon: iconHospital}).bindPopup(hospital03,popupOptions).addTo(hospitals);
